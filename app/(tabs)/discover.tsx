  ...
  return (
    <ParallaxScrollView
      ...
      <ThemedView style={styles.stepContainer}>
        ...
        <ThemedText>
          Start discovering amazing people around you. Swipe to find your perfect match!
        </ThemedText>
      </ThemedView>
      <ThemedView style={styles.stepContainer}>
        <ThemedText type="subtitle">Ready to begin?</ThemedText>
        <ThemedText>
          Your dating journey starts here. Explore profiles and make meaningful connections.
        </ThemedText>
      </ThemedView>
